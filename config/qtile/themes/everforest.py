...
groups.append(ScratchPad("scratchpad", [
    ...
    DropDown("mus", "alacritty --class=mus -e ncmpcpp", width=0.8, height=0.8, x=0.1, y=0.1, opacity=0.9),
...
screens = [
    Screen(bottom=bar.Bar(widgets=widgets_list, size=24, background=backgroundColor, margin=0, opacity=0.8),),
    Screen(bottom=bar.Bar(widgets=secondary_widgets_list, size=25, background=backgroundColor, margin=0, opacity=0.8),),
    ]
