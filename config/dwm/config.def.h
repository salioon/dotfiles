...
// #include "/home/sweetmask/.cache/wal/colors-wal-dwm.h"
...
static Keychord *keychords[] = {
  ...
  // my scripts
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_p}},     spawn,     SHCMD("passmenu -p \"󰢁 Pass: \"")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_m}},     spawn,     SHCMD("man-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_q}},     spawn,     SHCMD("logout-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_k}},     spawn,     SHCMD("kill-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_e}},     spawn,     SHCMD("confedit-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_w}},     spawn,     SHCMD("wifi-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_o}},     spawn,     SHCMD("openvpn-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_s}},     spawn,     SHCMD("setbg-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_b}},     spawn,     SHCMD("bookman-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_n}},     spawn,     SHCMD("noter-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_r}},     spawn,     SHCMD("radio-script.sh")}),
  &((Keychord){2, {{MODKEY, XK_p}, {0, XK_v}},     spawn,     SHCMD("record-script.sh")}),
  &((Keychord){1, {{0,XK_Print}},                  spawn,     SHCMD("maim-script.sh")}),
  &((Keychord){1, {{MODKEY, XK_x}},                spawn,     SHCMD("monitors-script.sh")}),
  &((Keychord){1, {{MODKEY, XK_F2}},                spawn,    SHCMD("change_wallpaper")}),
  &((Keychord){1, {{MODKEY, XK_z}},                 spawn,    SHCMD("changexmap")}),
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
