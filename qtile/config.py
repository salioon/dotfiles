...
groups.append(ScratchPad("scratchpad", [
    ...
    DropDown("nitrogen", "nitrogen", width=0.8, height=0.8, x=0.1, y=0.1, opacity=1),
    DropDown("ranger", "kitty --class=ranger -e ranger", width=0.8, height=0.8, x=0.1, y=0.1, opacity=0.9),
    DropDown("tilix", "tilix", width=0.8, height=0.8, x=0.1, y=0.1, opacity=0.9),
    DropDown("pcmanfm", "pcmanfm", width=0.8, height=0.8, x=0.1, y=0.1, opacity=0.9),
    DropDown("alacritty", "alacritty -e fish", width=0.8, height=0.8, x=0.1, y=0.1, opacity=0.9),
...
keys.extend([
    ...
    Key([mod], "v", lazy.group['scratchpad'].dropdown_toggle('tilix')),
    Key([mod], "m", lazy.group['scratchpad'].dropdown_toggle('pcmanfm')),
    Key([mod], "b", lazy.group['scratchpad'].dropdown_toggle('news')),
    Key([mod], "z", lazy.group['scratchpad'].dropdown_toggle('alacritty')),
    Key([mod, "shift"], "n", lazy.group['scratchpad'].dropdown_toggle('nitrogen')),
])
